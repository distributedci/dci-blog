...
Note that this presentation is based on CNF Cert Suite v4.2.4. Please check regularly the `cnf-cert` role documentation to see what's new for the latest CNF Cert Suite stable release, because the information you will see in this blog post may be different for different releases than v4.2.4.
