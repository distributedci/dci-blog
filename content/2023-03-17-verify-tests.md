...
Now let's verify test results with the DCI tool. DCI stands for [Distributed CI](introduction-to-the-red-hat-distributed-ci), which is a great CI tool written in Ansible that can help you deploy OCP clusters with multiple installers, automate the deployment of your plugins and workloads, and run various tests.
...
*Fig. 4. Failed expectations listed.*
        ...
        for preflight_operator_simple-demo-operator_0.0.6_results-junit.xml]
        0s
