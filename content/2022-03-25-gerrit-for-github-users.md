...
- You go read the collaboration notes to adjust the steps as required, this could include, creating an issue first, running tests prior to submitting a pull request, lint your code, etc.
- You "fork" the repo to your account (github.com/collaborator/repo)
- You clone *your* forked repo locally (`git clone ...`)
- You create a branch (`git checkout -b my_fix ...`), this is optional but is highly encouraged
...
- You get approval and your changes are merged in the repository
- Profit!
...
- You go to the awesome Gerrit repo you would like to contribute
- You go read the collaboration notes to adjust the steps as required, this could include, creating an issue first, running tests prior to submitting a pull request, lint your code, etc.
...
- You wait patiently for feedback, sometimes this takes some back and forth to get your changes in the desired state
- You modify your commit based on the feedback, sometimes you rebase, add changes, at the end you amend the commit (`git commit --amend`) and push (`git review`)
...
| Gerrit | GitHub|
|---| --- |
| You found an awesome Gerrit repo you would like to contribute | You found an awesome GitHub repo you would like to contribute |
| You go read the collaboration notes, etc. | You go read the collaboration notes, etc. |
| You clone the repo locally, copying the hooks | You "fork" the repo to your account |
|  | You clone *your* forked repo locally |
| You create a branch | You create a branch |
| You make your changes, in **one single commit** | You make your changes, either in one commit or multiple commits |
| You use git-review to push your changes and create the change request | You push your changes in your branch to your repo |
|  | You open a pull-request (PR) in the awesome GitHub repo you forked |
| You wait patiently for feedback... | You wait patiently for feedback... |
| You modify your commit based on the feedback, sometimes you rebase, at the end, you amend the **single commit** and push | You create more commits based on the feedback, sometimes you rebase, or squash commits and keep pushing them to your branch in your repo |
| You get approval and your changes are merged in the repository | You get approval and your changes are merged in the repository |
| Profit! | Profit! |
