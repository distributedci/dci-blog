Title: Using dci pipeline podman image
...
This article is about using dci via Podman. If you're not familiar with dci-pipeline, start by reading this post: https://blog.distributed-ci.io/dci-pipeline.html
