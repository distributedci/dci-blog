Title: Networking Considerations for Distributed Deployment of Libvirt/KVM-Based OCP Clusters
...
Let's check an example for IPI deployment. For this, you can take the [default inventory file from OCP on Libvirt](https://github.com/redhat-cip/dci-openshift-agent/blob/master/samples/ocp_on_libvirt/inventory/libvirt_resources.yml) as base, but you need to take into account the following changes, as this example is related to a single-cluster environment with internal IP addresses:
