...
:github: thekad
:summary: Adapting to Agent-Based installs on a virtualized cluster
...
2. Cheat and use the example `ansible playbook <examples/dci-lab-setup.yml>`_
...
.. include:: examples/dci-lab-setup.yml
   :code: yaml
   :number-lines: 6
   :start-line: 5
   :end-line: 23
...
There is yet another `example playbook <examples/vm-infrastructure.yml>`_ and,
