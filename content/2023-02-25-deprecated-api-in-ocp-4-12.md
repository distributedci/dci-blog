...
OpenShift provides a [metadata API called `apirequestcounts`](https://docs.openshift.com/container-platform/4.8/rest_api/metadata_apis/apirequestcount-apiserver-openshift-io-v1.html) that tracks the requests made to an API.
